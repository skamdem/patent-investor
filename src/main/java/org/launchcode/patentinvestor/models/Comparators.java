...
public class Comparators {
    ...
    public static Comparator<Stock> percentInPortfolioComparator
            ...
            - s2.getStockDetails().getNumberOfShares()*s2.getStockDetails().getLatestPrice() == 0)?0:((s1.getStockDetails().getNumberOfShares()*s1.getStockDetails().getLatestPrice()
    ...
    public static Comparator<Stock> numberOfSharesComparator
            = (s1, s2) -> Integer.compare(s1.getStockDetails().getNumberOfShares()
            - s2.getStockDetails().getNumberOfShares(), 0);
